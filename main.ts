...
class UpcomingSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		const pCoffee = createEl('p');
		const aCoffee = createEl('a');
		aCoffee.href = 'https://www.buymeacoffee.com/charliecm';
		const imgCoffee = createEl('img');
