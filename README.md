...
An [Obsidian](https://obsidian.md) plugin that opens upcoming daily notes in their own panes, so you can see and plan ahead. Check out the plugin settings before using the provided commands:
